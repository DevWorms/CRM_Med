...
<div class="col-md-3">
    ...
    <div class="list-group">
        ...
        <?php
        if ($perm_medico == 1) {
            //echo    '<a href="'. app_url() .'recibir_paciente" class="list-group-item"><i class="fa fa-clock-o"></i>&nbsp Médico - Pacientes en Espera <span class="label label-info counting" id="counterEnEspera">0</span></a>';
        ...
        if ($perm_administrador == 1) {
            ...
            //echo    '<a href="'. app_url() .'modificar_usuarios" class="list-group-item"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp Administrador - Modificar Usuarios</a>';
            //echo    '<a href="'. app_url() .'reporte_citas" class="list-group-item"><i class="fa fa-server"></i>&nbsp Administrador - Reporte Citas</a>';
            //echo    '<a href="'. app_url() .'reporte_citas_usuarios" class="list-group-item"><i class="fa fa-th-list"></i>&nbsp Administrador - Desempeño Citas</a>';
