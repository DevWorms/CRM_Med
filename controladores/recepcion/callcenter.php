        ...
        <div class="col-md-9">
            <div class="thumbnail">
                <div class="caption-full">
                    ...
                    <span class=" glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="right" title="Encuentra a un usuario a través del buscador escribiendo su nombre; si la búsqueda arroja un resultado, podrás reprogramar sus citas"></span>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-md-12" align="center">
                            <div align="center">
                                ...
                                <a class="btn btn-primary" data-toggle="tab" href="#firstDate" role="button">Usuarios de primera vez</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-content">
                        <div id="searchUser" class="tab-pane fade in active">
                                    ...
                                    <fieldset class="form-inline">
                                        ...
                                        <fieldset class="form-inline">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="search-query form-control" id="fecha" name="fecha" placeholder="aaaa / mm / dd" required disabled/>
                                                <span class="input-group-btn">
                                ...
                                <div class="col-md-3">
                                    <fieldset class="form-inline">
                                        <div align="center">
                                            ...
                                            <input type="text" class="form-control" id="hora" placeholder="hh:mm am" value="" disabled />
                                        </div>
                                    </fieldset>
                                ...
                                <div class="col-md-4">
                                    <fieldset class="form-inline">
                                        <div align="center">
                                            ...
                                            <textarea id="comentario_cita" name="comentario_cita" class="form-control" rows="5" disabled></textarea>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="center">
                                <div class="col-md-12">
                                    <a class="btn btn-success" href="#" id="registrar_cita" role="button" style="visibility: hidden"><span class="glyphicon glyphicon-edit"></span> Actualizar Cita</a>
                                ...
                                <div class="col-md-3">
                                    <fieldset class="form-inline">
                                        <div align="center">
                                            ...
                                            <input type="text" class="form-control" id="new_hora" name="new_hora" placeholder="hh:mm am"
                                                   value=""/>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <fieldset class="form-inline">
                                        <div align="center">
                                            ...
                                            <textarea id="new_comentario_cita" name="new_comentario_cita" class="form-control" rows="3"></textarea>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
