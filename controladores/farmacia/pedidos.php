        ...
        <div class="row">
           ...
           <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <a href="pedidos.php" class="list-group-item disabled active"><span class="glyphicon glyphicon-edit"></span>&nbsp &nbsp Ordenes de Pedido</a>

                    <a href="catalogos.php" class="list-group-item"><span class="glyphicon glyphicon-th"></span>&nbsp &nbsp Catálogos</a>
                    
                    <a href="gestion-calidad.php" class="list-group-item disabled"><span class="glyphicon glyphicon-cog"></span>&nbsp &nbsp Gestión de Calidad</a>
            ...
            <div class="col-md-9">
                <div class="thumbnail">
                    <div class="caption-full">
						<h4><a href="#">Ordenes de Pedido</a></h4> 
						<div class="row">
