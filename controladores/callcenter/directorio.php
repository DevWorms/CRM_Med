            ...
            <div class="col-md-9">
                <div class="thumbnail border_content">
                    <div class="caption-full">
                        ...
                        <h2 style="display:inline;" class="title_header">Call Center - Directorio de Leads </h2>

                        <span class=" glyphicon glyphicon-question-sign circulo_info" data-toggle="tooltip" data-placement="right" title="Información de leads registrados."></span>
                        <hr>
                        <div id="error"></div>
